...
import com.jk.car.utils.UtilFormDate;
...
public class Car implements Serializable {
    ...
    private String carLicenseYearStr;

    private Date carLicenseMonth;

    private String carLicenseMonthStr;

    public String getCarLicenseYearStr() {
        if(this.getCarLicenseYear() != null){
            this.carLicenseYearStr = UtilFormDate.formatDate("yyyy-MM-dd", this.getCarLicenseYear());
        }
        return carLicenseYearStr;
    }

    public void setCarLicenseYearStr(String carLicenseYearStr) {
        this.carLicenseYearStr = carLicenseYearStr;
    }

    public String getCarLicenseMonthStr() {
        if(this.getCarLicenseMonth() != null){
            this.carLicenseMonthStr = UtilFormDate.formatDate("yyyy-MM-dd", this.getCarLicenseMonth());
        }
        return carLicenseMonthStr;
    }

    public void setCarLicenseMonthStr(String carLicenseMonthStr) {
        this.carLicenseMonthStr = carLicenseMonthStr;
    }
